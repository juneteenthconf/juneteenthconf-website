...
url = 'https://sessionize-schedule-api.azurewebsites.net/api/schedule?code=AO5ZY8a0eLldyvPlKhy0pHkK6CNcVsBqs/osxa8amsPahwlwLAWEzA==&clientId=default&url=https://sessionize.com/api/v2/95ixt6b1/view/All&sessionlist=true'
r = requests.get(url)
